...
function AboutMe() {
    return (
        <Container fluid className="about-me-section">
            <Container>
                <Row style={{justifyContent: "center", padding: "10px"}} className="about-row">
                    <Col md={7} style={{justifyContent: "center"}} className="about-me-blurb">
                        <h1 className="about-me-title" style={{paddingBottom: "60px"}}>
                            About Me
                        </h1>
                        <p style={{}} className="about-body">
                            ...
                            to help construct and develop new ideas for websites.
                    ...
                    >
                    <img src={personalPic} style={{ borderRadius: "25px"}} 
                    alt="about" 
                    className="img-fluid" 
                    />
                    </Col>
                    <h1 className="skillset">
                        Technological <strong style={{color: "#FF4500"}}> Skills </strong>
                    </h1>
                    ...
                    <h1 className="skillset">
                        Tools <strong style={{color: "#FF4500"}}> Skillset </strong>
                    </h1>
